...
` +
  ...
  return (
    ...
    <PanelDuzen
      ...
      yan={<>
        {/* Gelişimim: hafta hafta seri, sınav analizi, konu ilerlemesi
            ve akıllı analiz aynı soruyu farklı açılardan yanıtlıyor —
            dördü ayrı kart olarak alt alta durmasın. */}
        <Bolum baslik="Gelişimim" color={c} sekmeler={[
          { ad: "Haftalık", icerik: <HaftalikOzet studentId={userId} color={c} baslik="Haftalık Gelişimim" /> },
          { ad: "Sınav Analizi", id: "bolum-sinav",
            icerik: <div id="bolum-sinav"><div id="bolum-sinav"><SinavAnalizi studentId={userId} color={c} /></div></div> },
          { ad: "Konularım", icerik: (
                  <Card>
          ...
          { ad: "Akıllı Analiz", icerik: analiz ? (
            <Card>
        ...
        <Bolum baslik="Başarılarım" color={c} sekmeler={[
          { ad: "Seviyem", icerik: <SeviyeAvatar studentId={userId} color={c} /> },
